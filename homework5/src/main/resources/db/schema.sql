...
CREATE TABLE BOOK_AUTHOR (
     ...
     CONSTRAINT FK__BOOK_AUTHOR__BOOK FOREIGN KEY (BOOK_ID) REFERENCES BOOK (BOOK_ID),
...
CREATE TABLE BOOK_GENRE (
     ...
     CONSTRAINT FK__BOOK_GENRE__BOOK FOREIGN KEY (BOOK_ID) REFERENCES BOOK (BOOK_ID),
